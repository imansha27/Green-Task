<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Adminpanel2.aspx.cs" Inherits="project2.Adminpanel2" %>
...
<head runat="server">
    ...
    #ArticleList tr:hover {background-color: #ddd;}
...
<body>
    ...
    <h1>Article List</h1>
    <div>
        <asp:Button runat="server" ID="AddButton" Text="Add Articles" PostBackUrl='<%# "CreateArticle.aspx?Id=" + Eval("Id") %>' CssClass="button" OnClick="AddButton_Click" />
        ...
        <asp:GridView ID="ArticleList" runat="server" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:ImageField DataImageUrlField="Picture" HeaderText="Picture" ControlStyle-Width="100" ControlStyle-Height="100" />
                <asp:BoundField DataField="Description" HeaderText="Description" />
                <asp:BoundField DataField="Published_date" HeaderText="Published Date" />
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        <asp:Button runat="server" ID="EditButton" Text="Edit" PostBackUrl='<%# "EditArticle.aspx?Id=" + Eval("Id") %>' CssClass="button" />
